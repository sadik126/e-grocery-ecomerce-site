...
if(isset($_POST['submit'])){
  ...
  $showerror = false;
   ...
   $existSql = "select * from products where name = '$name'";
...
?>
  ...
  <form method="POST" action=" " name="myform"style="min-height: 70vh;"onsubmit="return validateForm()" enctype="multipart/form-data">
    ...
    <tr id="name" align="center">
      <td><b>NAME</b></td>
      <td>
      	<input type="text"  maxlength="11" name="name" size="30"  style="border-radius: 7px;"><br><b><span style="color: orangered;" class="formerror"></span></b>
      </td>
    </tr>
    ...
    <tr id="dis" align="center">
      ...
      <td>
      	<textarea  name="dis" rows="6" cols="32" style="border-radius: 7px;"></textarea><br><b><span style="color: orangered;" class="formerror"></span></b>
      </td>
    </tr>
    ...
    <tr id="price" align="center">
      <td><b>PRICE</b></td>
      <td>
      	<input type="text" maxlength="20" name="price" size="30"style="border-radius: 7px;"><br><b><span style="color: orangered;" class="formerror"></span></b>
      </td>
    </tr>
...
<script>
    ...
    if(dis.length==0){
      seterror("dis","*Please fill up the name");
      returnval= false;
    }
    ...
    if(price.length<2){
      seterror("price","*Length of price is too short");
      returnval= false;
    }
    if(price.length==0){
      seterror("price","*Please fill up the price");
      returnval= false;
    }
