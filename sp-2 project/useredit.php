...
<table cellpadding="3" width="50%" bgcolor="white" align="center"cellspacing="15">
    ...
    <tr id="username">
      <td>USERNAME</td>
      <td>
        <input type="text" maxlength="20" name="username" size="30" value="'.$row['username'].'"style="border-radius: 7px;"><b><span style="color: red;" class="formerror"></span></b>
      </td>
    </tr>
 ...
 <?php
  if(isset($_POST['updatedata']))
  {
    ...
    $sql="update customers set name='$_POST[name]',email='$_POST[email]',dateofbirth='$_POST[date]',password='$_POST[password]',gender='$_POST[gender]'where username='$_POST[username]'";
